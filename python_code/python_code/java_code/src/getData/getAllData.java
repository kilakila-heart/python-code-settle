...
public final class getAllData {

	public static void main(String args[]) throws IOException {
		getAllData GAD = new getAllData();
		GAD.getAllData_function(
				"E:\\Data\\feature\\balance-month\\yoochoose-feature-all-",
	...
	private void getAllData_function(String fileName, String buyFile,
